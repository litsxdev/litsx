...
Your project will also need the usual runtime dependencies used by compiled LitSX output, such as `lit`, `litsx`, and `@open-wc/scoped-elements`, depending on the features you use.
